...
open_machine_learning_ws(){
    code $HOME/vsc_workspaces/machine_learning.code-workspace
}

open_fitness_tracker_ws(){
    code $HOME/vsc_workspaces/fitness_tracker.code-workspace
}